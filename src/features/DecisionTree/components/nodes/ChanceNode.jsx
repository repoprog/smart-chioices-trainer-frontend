    ...
    <div className="relative flex items-center justify-center gap-0.5">
      ...
      <div className={`
        ...
        ${isHighlighted
          ...
          : 'bg-white border-slate-400 shadow-[0_1px_3px_rgba(0,0,0,0.07),inset_0_1px_0_rgba(255,255,255,0.9)] dark:bg-slate-900/80 dark:border-slate-800 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]'
        }
      `}>
        <span className={`
